...
$classes = ($active ?? false)
            ...
            : 'block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-gray-600 dark:text-slate-400 hover:text-gray-800 dark:text-slate-200 hover:bg-gray-50 dark:bg-slate-800 hover:border-gray-300 focus:outline-none focus:text-gray-800 dark:text-slate-200 focus:bg-gray-50 dark:bg-slate-800 focus:border-gray-300 transition duration-150 ease-in-out';
@endphp
